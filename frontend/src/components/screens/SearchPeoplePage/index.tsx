...
export default function SearchPeoplePage() {
  ...
  return <div className={classes.searchPeopleBlock}>
    ...
    {data && Array.isArray(data) && data.length > 0 ? <UsersGridCard users={data} isLoading={isLoading} refetch={refetch} /> : <p>People not found</p>}
  </div>
}
