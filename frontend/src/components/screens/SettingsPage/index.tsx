...
export default function SettingsPage() {
  ...
  const { data, isLoading } = useQuery({
    queryKey: ['me'],
    queryFn: () => fetcher<IUser>(`users/me?populate[avatar]=*`, { method: 'GET', isAuth: true }),
  });
          ...
          <div className={classes.mainInfo}>
            <div className={classes.mainInfo_avatar}>
              <div>
                ...
                <UploadAsset
                  show={isChangeState && !isAssetsLoading}
                  setUploadAssets={(value) => setUploadAsset(value[0])}
                  setIsLoading={setIsAssetsLoading}
                >
                  <CameraIcon />
                </UploadAsset>
              </div>
            ...
            {[
              ...
              <div key={key}>
                ...
                <Field
                  ...
                  defaultValue={
                    data ? data[field.name as keyof Omit<IUser, 'avatar' | 'friends' | 'chats' | 'blockedPeople'>] : ''
                  }
                  Icon={field.Icon}
                  disabled={!isChangeState}
