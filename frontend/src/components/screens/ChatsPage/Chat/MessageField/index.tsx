    ...
    return (
      <div className={classes.messageBlock}>
        ...
        <div className={classes.messageBlock_actions}>
            {mediaBlobUrl ?
                <button onClick={clearBlobUrl}><Trash2Icon /></button> :
                <button>
                    <MediaTooltip
            ...
            <div className={classes.messageBlock_buttons}>
                <button><SmilesTooltip setMessage={setMessage} /></button>
                {
                    mediaBlobUrl || message || uploadAssets.length > 0  ? <button onClick={onSend}><SendIcon /></button> :
